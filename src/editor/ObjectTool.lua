...
function ObjectTool:selected(selectedButtonName)
    print("ObjectTool:selected(selectedButtonName) selectedButtonName = "..tostring(selectedButtonName))
...
function ObjectTool:onTouchSelectObject(event, x, y)
    print("ObjectTool:onTouchSelectObject(event, x, y)")
    if event == "began" then
...
function ObjectTool:showToolbox(mapX, mapY)
    ...
    -- local allIds = StaticObjectsProperties.getStaticIds()  
    local allIds = StaticObjectsProperties.getTowerLocationIds()  
